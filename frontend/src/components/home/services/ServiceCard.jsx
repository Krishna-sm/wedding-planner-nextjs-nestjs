...
const ServiceCard = ({data}) => {
  ...
  return (
    <>
         <Link href={`/service/${data?.category?.slug}/${data.slug}`}  id='service_card' className="p-4  sm:mb-0 mb-6 border border-transparent hover:border-logo transition-all duration-300 hover:rounded-2xl">
